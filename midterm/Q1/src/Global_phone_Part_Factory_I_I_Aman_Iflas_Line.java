/**
 * class Global_phone_Part_Factory_I_I_Aman_Iflas_Line .
 * responsible for produce components for the I_I_Aman_Iflas model in Global .
 */
public class Global_phone_Part_Factory_I_I_Aman_Iflas_Line implements Phone_Parts_Factory{
    ...
    public Battery produce_Battery() {
        return new phone_Battery(Battery_type.Lithium_Ion,Battery_cap._2000,Battery_time._16);
    }

    @Override
    public CPU_RAM produce_CPU_RAM() {
        return new phone_CPU_RAM(phoneCPU._2_2,phoneRAM._4,phoneCORE._2);
    }
