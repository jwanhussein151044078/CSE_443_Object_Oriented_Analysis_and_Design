/**
 * class Global_phone_Part_Factory_MaximumEffort_Line
 * responsible for produce components for the MaximumEffort model in Global .
 */
public class Global_phone_Part_Factory_MaximumEffort_Line implements Phone_Parts_Factory{
    ...
    public Camera produce_Camera() {
        return new phoneCamera(phoneFrontcam._12 , phoneRearcam._8,phoneCamZoom._2);
    }

    @Override
    public Case produce_Case() {
        return new phoneCase(phoneCaseMaterial.aluminum ,phoneCaseSize._151x73x7_7 ,true , true , 50 );
    }
}
